    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center py-32">
        ...
        >
          ...
          <TextAnimate className="text-center mt-2 text-sm md:text-base max-w-sm md:max-w-md" animation="blurInUp" by="character" delay={0.5} once>
            AI-powered Upwork proposals backed by
          </TextAnimate>
          <TextAnimate className="text-center text-sm md:text-base max-w-sm md:max-w-md" animation="blurInUp" by="character" delay={0.6} once>
